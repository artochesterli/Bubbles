...
public class MoveOutBackAccelerationTask : Task
{
    ...
    public MoveOutBackAccelerationTask(GameObject obj, float backdis, float backtime, Vector2 dir, float inflatedscale)
    {
        Obj = obj;
        MoveBackDis = backdis;
    ...
    internal override void Update()
    {
        ...
        BackSpeed = Mathf.Lerp(0, MaxBackSpeed, TimeCount / (MoveBackTime / 2));

        Obj.transform.localScale = Vector3.Lerp(Vector3.one * PowerUpSelfInflatedScale, Vector3.one, TimeCount / MoveBackTime);
